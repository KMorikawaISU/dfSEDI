...
This section shows a minimal example using **one simulated dataset** (no Monte Carlo repetition).
We reproduce a simple dual-frame scenario similar to that in the paper.
...
- `theta` : point estimate of the target parameter (e.g., population mean)
...
on a single dual-frame dataset, without running any Monte Carlo experiments.
